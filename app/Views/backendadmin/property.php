            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel"
                        aria-hidden="true">
                        <!-- Your modal content for adding new property -->
                    </div>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="d-flex justify-content-center">
                                    <button class="btn btn-warning" data-toggle="modal" data-target="#editModal<?= $data['id_property'] ?>"><i
                            ...
                            <div class="modal fade" id="editModal<?= $data['id_property'] ?>" tabindex="-1"
                                        ...
                                        <form action="/property/edit" method="post">
                                            <div class="modal-body">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" name="harga_property" value="<?= $data['harga_property'] ?>" placeholder="Masukkan Foto Detail Property" class="form-control" id="exampleInputPassword1">
                                                </div>
                                                <div class="mb-3">
